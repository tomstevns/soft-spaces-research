...
Purpose
-------
v25.8 adds a local REAL-background profile around predeclared Soft-Space coordinates.
...
def main() -> None:
    ...
    ap.add_argument("--output", type=str, default="v25_8_local_real_profile_output.txt")
    args = ap.parse_args()
