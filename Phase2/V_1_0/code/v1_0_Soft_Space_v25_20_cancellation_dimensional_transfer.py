...
# -*- coding: utf-8 -*-
"""\
v1_0_Soft_Space_v25_20_cancellation_dimensional_transfer.py
...
def write_cancellation_dimensional_transfer_report(output_path: str, units: List[PathOrganizationUnit], summary: CancellationTransferSummary, meta: Dict[str, Any]) -> None:
    lines=[]
    lines.append('=== Soft Spaces Phase 2 v25.20 CROSS-DIMENSIONAL CANCELLATION TRANSFER ===')
...
def main() -> None:
    ap = argparse.ArgumentParser(description="Soft Spaces Phase 2 v25.20 predeclared cross-dimensional transfer of the REAL-vs-NULL cancellation law.")
