...
# -*- coding: utf-8 -*-
"""\
v1_0_Soft_Space_v25_14_anisotropy_generalization.py
...
def main() -> None:
    ap = argparse.ArgumentParser(description="Soft Spaces Phase 2 v25.14 multi-target X_P anisotropy generalization + frozen v25.13/v25.12/v25.11/v25.10/v25.9 diagnostics.")
