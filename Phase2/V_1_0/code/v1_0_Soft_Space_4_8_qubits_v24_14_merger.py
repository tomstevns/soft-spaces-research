...
def main():
    ...
    out = []
    out.append("=== v24.14 asymmetric dual-region REAL-only hotspot merger ===")
    ...
    out.append("")
    out.append("=== Cross-repeat hotspot recurrence by exact position (v24.14 merger) ===")
    ...
    out.append("")
    out.append("=== Cross-repeat hotspot recurrence by region (v24.14 merger) ===")
    ...
    out.append("")
    out.append("=== v24.14 reading ===")
    out.append("1) Test whether the asymmetric REAL-only prior consolidates the primary anchor family around (157,158).")
    out.append("2) Compare exact-position and region recurrence to see whether the secondary family remains useful or has largely dropped out.")
    out.append("3) If the primary family remains robust across repeats, move the next simulator version toward local ridge refinement around the dominant anchor.")
