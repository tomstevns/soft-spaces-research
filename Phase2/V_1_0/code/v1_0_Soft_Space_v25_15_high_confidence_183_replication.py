...
# -*- coding: utf-8 -*-
"""\
v1_0_Soft_Space_v25_15_high_confidence_183_replication.py
...
def main() -> None:
    ap = argparse.ArgumentParser(description="Soft Spaces Phase 2 v25.15 high-confidence replication of target-183 X_P anisotropy + frozen prior diagnostics.")
