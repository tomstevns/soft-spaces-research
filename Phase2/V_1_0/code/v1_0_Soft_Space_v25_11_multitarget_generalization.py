...
# -*- coding: utf-8 -*-
"""\
v1_0_Soft_Space_v25_11_multitarget_generalization.py
...
def main() -> None:
    ap = argparse.ArgumentParser(description="Soft Spaces Phase 2 v25.11 multi-target perturbative generalization + frozen v25.10/v25.9 diagnostics.")
