...
# -*- coding: utf-8 -*-
"""\
v1_0_Soft_Space_v25_10_perturbative_confirmation.py
...
def main() -> None:
    ap = argparse.ArgumentParser(description="Soft Spaces Phase 2 v25.10 predeclared perturbative confirmation + frozen v25.9/legacy diagnostics.")
