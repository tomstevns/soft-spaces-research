...
# -*- coding: utf-8 -*-
"""\
v1_0_Soft_Space_v25_18_path_organization.py
...
def main() -> None:
    ap = argparse.ArgumentParser(description="Soft Spaces Phase 2 v25.18 perturbative path-organization analysis: distributions, participation and cancellation.")
