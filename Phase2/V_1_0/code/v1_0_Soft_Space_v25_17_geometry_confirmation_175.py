...
# -*- coding: utf-8 -*-
"""\
v1_0_Soft_Space_v25_17_geometry_confirmation_175.py
...
def main() -> None:
    ap = argparse.ArgumentParser(description="Soft Spaces Phase 2 v25.17 predeclared confirmation of target-175 local perturbative geometry.")
