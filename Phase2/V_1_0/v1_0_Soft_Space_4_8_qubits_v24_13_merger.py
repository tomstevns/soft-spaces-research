...
def main():
    ...
    out = []
    out.append("=== v24.13 dual-region REAL-only hotspot merger ===")
    ...
    out.append("")
    out.append("=== Cross-repeat hotspot recurrence by exact position (v24.13 merger) ===")
    ...
    out.append("")
    out.append("=== Cross-repeat hotspot recurrence by region (v24.13 merger) ===")
    ...
    out.append("")
    out.append("=== v24.13 reading ===")
    out.append("1) Test whether the dual-region REAL-only prior stabilizes both recurrent anchors across independent repeats.")
    out.append("2) Compare exact-position recurrence and region recurrence to see whether dual targeting reduces fragmentation.")
    out.append("3) If one anchor dominates while the other weakens, keep the dual-region setup but rebalance region vs anchor bonus scales in the next version.")
