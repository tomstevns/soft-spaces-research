...
# -*- coding: utf-8 -*-
"""\
v1_0_Soft_Space_4_8_qubits_v24_8_3.py
...
def broaden_kernel_selection(
    ...
    # If true multi-point kernels cannot reach target coverage, keep the best multi-point set.
    if best_rows:
...
def main() -> None:
    ap = argparse.ArgumentParser(description="v0_7 convergence harness v24.8.3 (static REAL-vs-NULL + multi-point kernel-zoom dynamic comparison).")
    ...
    header = []
    header.append("=== v0_7: Convergence + Baseline Calibration + Perturbation Robustness + Gap/Isolation + Open-system (v24.8.3) ===")
    ...
    header.append("Pauli ops: lazy on-demand cache (excluding all-I); 8-qubit-safe v24.8.3 broadened kernel evidence merge")
    header.append("")
    header_text = "\n".join(header)
