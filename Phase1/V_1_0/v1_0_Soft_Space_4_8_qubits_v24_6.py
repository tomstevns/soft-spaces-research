...
# -*- coding: utf-8 -*-
"""\
v1_0_Soft_Space_4_8_qubits_v24_6.py
...
# ----------------------------
# Pauli operator cache (dimension dependent; v24.6 lazy/on-demand)
# ----------------------------
...
def open_system_summary_for_batch(
    *,
    ...
    """Open-system summaries for REAL/NULL plus structure-retention metrics (v24.6)."""
...
def main() -> None:
    ap = argparse.ArgumentParser(description="v0_7 convergence harness v24.6 (static REAL-vs-NULL + deeper dynamic/open-system REAL-vs-NULL comparison).")
    ...
    ap.add_argument("--output", type=str, default="v0_7_convergence_families_v24_6_output.txt")
    args = ap.parse_args()
    ...
    header = []
    header.append("=== v0_7: Convergence + Baseline Calibration + Perturbation Robustness + Gap/Isolation + Open-system (v24.6) ===")
    ...
    header.append("Pauli ops: lazy on-demand cache (excluding all-I); 8-qubit-safe v24.6")
    header.append("")
    header_text = "\n".join(header)
