...
# -*- coding: utf-8 -*-
"""\
v1_0_Soft_Space_4_8_qubits_v24.py
...
def main() -> None:
    ...
    ap.add_argument("--os_time_mode", type=str, default="mean", choices=["snapshot", "mean", "auc", "late", "peak"], help="How to reduce open-system time curves to one scalar per pair for summary reporting.")
