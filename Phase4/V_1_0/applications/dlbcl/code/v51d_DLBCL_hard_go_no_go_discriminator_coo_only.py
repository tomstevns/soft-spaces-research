...
"""
Soft Spaces / DLBCL
v51d MASTER GO/NO-GO DISCRIMINATOR — COO-ONLY PARSER
...
def parse_abc_gcb_labels(sample_text):
    ...
    (cell of origin), and ONLY the exact values ABC or GCB.
...
def main():
    ...
    print("=" * 72)
    print("Soft Spaces / DLBCL v51d GO/NO-GO DISCRIMINATOR")
...
v51d.0 — HARD GO/NO-GO DISCRIMINATOR PREREGISTRATION
...
--------------------
v51b and v51c both stopped before scientific scoring because their metadata
parsers classified GSE87371 as ABC=83, GCB=0.

v51d changes ONLY ABC/GCB metadata extraction.

Accepted label source:
    !Sample_characteristics ... = coo: ABC
    !Sample_characteristics ... = coo: GCB

All other metadata are ignored for subtype assignment, including PMBL.
...
"""
    ...
    protocol_path = docs / "v51d_0_DLBCL_GO_NO_GO_PREREGISTRATION.txt"
    protocol_path.write_text(protocol, encoding="utf-8")
    protocol_sha = sha256_file(protocol_path)

    write_json(
        docs / "v51d_0_DLBCL_GO_NO_GO_PREREGISTRATION_manifest.json",
        {
            "version": "v51d.0",
    ...
    for cohort_i, (gse, spec) in enumerate(COHORTS.items()):
        ...
        label_audit_path = (
            results
            / f"v51d_{gse}_ABC_GCB_label_parser_audit.tsv"
        )
    ...
    closure_path = docs / "v51d_1_DLBCL_GO_NO_GO_CLOSURE.txt"

    lines = [
        "Soft Spaces / DLBCL",
        "v51d.1 — HARD GO/NO-GO DISCRIMINATOR CLOSURE",
        "",
        "STATUS",
        "------",
        "CLOSED",
    ...
    manifest_path = docs / "v51d_1_DLBCL_GO_NO_GO_CLOSURE_manifest.json"
    ...
    summary_path = results / "v51d_DLBCL_go_no_go_summary.txt"

    summary = f"""=== Soft Spaces / DLBCL v51d GO/NO-GO SUMMARY ===
...
"""
    ...
    print()
    print("=" * 72)
    print("v51d DLBCL GO/NO-GO COMPLETE")
    print("=" * 72)
    print(summary)
    print("Closure:")
    print(" ", closure_path)
