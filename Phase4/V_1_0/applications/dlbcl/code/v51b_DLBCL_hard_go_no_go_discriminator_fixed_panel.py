...
"""
Soft Spaces / DLBCL
v51b MASTER GO/NO-GO DISCRIMINATOR
...
def main():
    ...
    print("=" * 72)
    print("Soft Spaces / DLBCL v51b GO/NO-GO DISCRIMINATOR")
...
v51b.0 — HARD GO/NO-GO DISCRIMINATOR PREREGISTRATION
...
"""
    ...
    protocol_path = docs / "v51b_0_DLBCL_GO_NO_GO_PREREGISTRATION.txt"
    protocol_path.write_text(protocol, encoding="utf-8")
    protocol_sha = sha256_file(protocol_path)

    write_json(
        docs / "v51b_0_DLBCL_GO_NO_GO_PREREGISTRATION_manifest.json",
        {
            "version": "v51b.0",
    ...
    closure_path = docs / "v51b_1_DLBCL_GO_NO_GO_CLOSURE.txt"

    lines = [
        "Soft Spaces / DLBCL",
        "v51b.1 — HARD GO/NO-GO DISCRIMINATOR CLOSURE",
        "",
        "STATUS",
        "------",
        "CLOSED",
    ...
    manifest_path = docs / "v51b_1_DLBCL_GO_NO_GO_CLOSURE_manifest.json"
    ...
    summary_path = results / "v51b_DLBCL_go_no_go_summary.txt"

    summary = f"""=== Soft Spaces / DLBCL v51b GO/NO-GO SUMMARY ===
...
"""
    ...
    print()
    print("=" * 72)
    print("v51b DLBCL GO/NO-GO COMPLETE")
    print("=" * 72)
    print(summary)
    print("Closure:")
    print(" ", closure_path)
