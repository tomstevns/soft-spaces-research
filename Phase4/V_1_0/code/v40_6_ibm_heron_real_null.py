...
-----
Preflight only:
    python -X utf8 -u .\v40_6_ibm_heron_real_null.py

Submit the frozen scientific test:
    python -X utf8 -u .\v40_6_ibm_heron_real_null.py --submit
"""
...
VERSION = "v40.6-heron-real-null-1"
...
DEFAULT_OUTPUT = Path("v40_6_ibm_heron_real_null_result.json")
DEFAULT_PREFLIGHT = Path("v40_6_ibm_heron_real_null_preflight.json")
