...
# -*- coding: utf-8 -*-
"""\
v1_0_Soft_Space_4_8_qubits_v24_7.py
...
# ----------------------------
# Pauli operator cache (dimension dependent; v24.7 lazy/on-demand)
# ----------------------------
...
def open_system_summary_for_batch(
    *,
    ...
    """Open-system summaries for REAL/NULL plus structure-retention metrics (v24.7)."""
...
def main() -> None:
    ap = argparse.ArgumentParser(description="v0_7 convergence harness v24.7 (static REAL-vs-NULL + deeper dynamic/open-system REAL-vs-NULL comparison).")
    ...
    header = []
    header.append("=== v0_7: Convergence + Baseline Calibration + Perturbation Robustness + Gap/Isolation + Open-system (v24.7) ===")
    ...
    header.append("Pauli ops: lazy on-demand cache (excluding all-I); 8-qubit-safe v24.7")
    header.append("")
    header_text = "\n".join(header)
            ...
            if bool(args.open_system):
                ...
                if isinstance(osb, dict) and meta:
                    ...
                    out(
                        ...
                        f"time_mode={meta.get('time_mode')} | late_power={meta.get('time_late_power')} | contrast_focus={meta.get('contrast_focus')}"
                    )
