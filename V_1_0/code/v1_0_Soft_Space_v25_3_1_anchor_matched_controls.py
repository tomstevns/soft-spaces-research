...
# -*- coding: utf-8 -*-
"""\
v1_0_Soft_Space_v25_3_1_anchor_matched_controls.py
...
def main() -> None:
    ap = argparse.ArgumentParser(description="Soft Spaces Phase 2 v25.3.1 anchor continuation with geometry-matched paired controls.")
    ...
    header = []
    header.append("=== Soft Spaces Phase 2 v25.3.1 ANCHOR CONTINUATION + MATCHED PAIRED CONTROLS ===")
    ...
    header.append("Pauli ops: lazy on-demand cache; v25.3.1 geometry-matched control layer only, baseline REAL/NULL physics preserved")
    header.append("")
    header_text = "\n".join(header)
