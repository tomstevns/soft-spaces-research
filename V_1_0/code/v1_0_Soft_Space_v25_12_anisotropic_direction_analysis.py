...
# -*- coding: utf-8 -*-
"""\
v1_0_Soft_Space_v25_12_anisotropic_direction_analysis.py
...
def main() -> None:
    ap = argparse.ArgumentParser(description="Soft Spaces Phase 2 v25.12 anisotropic protected-direction analysis + frozen v25.11/v25.10/v25.9 diagnostics.")
