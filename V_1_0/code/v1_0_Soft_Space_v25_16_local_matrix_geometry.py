...
# -*- coding: utf-8 -*-
"""\
v1_0_Soft_Space_v25_16_local_matrix_geometry.py
...
def main() -> None:
    ap = argparse.ArgumentParser(description="Soft Spaces Phase 2 v25.16 local differential geometry of the effective 2D perturbative matrices.")
