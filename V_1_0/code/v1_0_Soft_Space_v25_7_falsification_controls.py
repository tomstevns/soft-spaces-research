...
Purpose
-------
v25.7 adds a predeclared falsification layer with paired geometry-matched source-space controls.
It preserves the v25.5.1/v25.6 physics definitions and does not fit a new continuation score.
...
def main() -> None:
    ap = argparse.ArgumentParser(description="Soft Spaces Phase 2 v25.7 falsification controls + v25.6 confirmation diagnostics.")
    ...
    ap.add_argument("--output", type=str, default="v25_7_falsification_output.txt")
    args = ap.parse_args()
