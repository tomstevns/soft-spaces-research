...
# -*- coding: utf-8 -*-
"""\
v1_0_Soft_Space_v25_9_effective_subspace_perturbation.py
...
def write_effective_subspace_report(
    ...
    for u in units:
        lines.append(
            ...
            f"{u.x_trace:.6e} | {u.x_det:.6e} | ({u.x_eig_lo:.6e},{u.x_eig_hi:.6e}) | {u.x_split:.6e} | {u.x_fro:.6e} | {u.x_offdiag_abs:.6e} | {u.x_anisotropy:.6e}"
        )
    lines.append('')
...
def main() -> None:
    ap = argparse.ArgumentParser(description="Soft Spaces Phase 2 v25.9 effective 2D-subspace perturbation analysis + frozen legacy diagnostics.")
