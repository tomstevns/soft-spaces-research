...
# -*- coding: utf-8 -*-
"""\
v1_0_Soft_Space_v25_13_anisotropy_confirmation.py
...
def main() -> None:
    ap = argparse.ArgumentParser(description="Soft Spaces Phase 2 v25.13 predeclared X_P anisotropy confirmation + frozen v25.12/v25.11/v25.10/v25.9 diagnostics.")
