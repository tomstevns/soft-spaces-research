...
# -*- coding: utf-8 -*-
"""\
v1_0_Soft_Space_v25_28_q11_dimensional_rule_test.py
...
def write_physics_hotspot_predictor_report(output_path, predictions, meta):
    ...
    lines.append("v25.26 is blind 10Q prediction/discovery only; candidates must be frozen before v25.28 unseen-seed confirmation.")
    lines.append("")
...
# ----------------------------
# v25.28 unseen-seed confirmation of blind 10Q hotspot predictions
# ----------------------------
    ...
    for b in range(int(batches)):
        ...
        for s in range(int(seeds_per_batch)):
            ...
            for family in families:
                for rep in range(int(reps)):
                    seed_pert = stable_hash_int(
                        f"V25.28|{family.upper()}|PERT|{seed}|rep{rep}"
                    )
                    dH = build_family_perturbation(
                        cache, perturb_terms_eff, seed_pert, family
                    )
...
def write_q11_dimensional_rule_test_report(output_path, summaries, meta):
    lines = []
    lines.append("=== Soft Spaces Phase 2 v25.28 PREDECLARED 11Q DIMENSIONAL-RULE TEST ===")
    ...
    lines.append("")
    lines.append("=== End of v25.28 10Q hotspot confirmation ===")
...
def main() -> None:
    ...
    # v25.28: unseen-seed confirmation of the exact v25.26 blind candidate list.
    ap.add_argument("--q11_dimensional_rule_test", action="store_true",
                    help="Run v25.28 unseen-seed confirmation of frozen blind 10Q hotspots and exit.")
