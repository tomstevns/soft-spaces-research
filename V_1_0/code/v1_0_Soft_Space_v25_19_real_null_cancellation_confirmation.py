...
# -*- coding: utf-8 -*-
"""\
v1_0_Soft_Space_v25_19_real_null_cancellation_confirmation.py
...
def main() -> None:
    ap = argparse.ArgumentParser(description="Soft Spaces Phase 2 v25.19 predeclared REAL-vs-NULL cancellation confirmation.")
