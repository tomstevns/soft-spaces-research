...
# -*- coding: utf-8 -*-
"""\
v1_0_Soft_Space_4_8_qubits_v24_9_2.py
...
def main() -> None:
    ap = argparse.ArgumentParser(description="v0_7 convergence harness v24.9.2 (static REAL-vs-NULL + sparse hotspot recurrence + stability scoring comparison).")
    ...
    header = []
    header.append("=== v0_7: Convergence + Baseline Calibration + Perturbation Robustness + Gap/Isolation + Open-system (v24.9.2) ===")
    ...
    header.append("Pauli ops: lazy on-demand cache (excluding all-I); 8-qubit-safe v24.9.2 sparse hotspot recurrence + stability scoring merge")
    header.append("")
    header_text = "\n".join(header)
