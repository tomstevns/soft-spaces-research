...
def main() -> None:
    ...
    parser.add_argument(
        "--output",
        type=Path,
        default=Path("v32_5_multivariate_hotspot_model_output.txt"),
    )
    parser.add_argument(
        "--csv",
        type=Path,
        default=Path("v32_5_multivariate_hotspot_model.csv"),
    )
    parser.add_argument(
        "--fold-csv",
        type=Path,
        default=Path("v32_5_multivariate_hotspot_model_folds.csv"),
    )
    ...
    report, folds = multivariate_summary(rows, args.alpha)
    print(report, end="")
